...
<div id="content" class="<?php if ($full_width) echo 'full_width'; ?>">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-layerslider" class="">
                    ...
                    <div class="tab-content">
                        <!-- General Settings -->
                        <div role="tabpanel" class="tab-pane <?php if (!$has_module_id) {
                                                                    echo 'active';
                                                                } ?>" id="home">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-width"><?php echo $entry_min_height; ?></label>
                                    <div class="col-sm-10">
                                        <input name="min_height" id="input-min_height" class="form-control" value="<?php echo $min_height; ?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-width"><?php echo $entry_full_width; ?></label>
                                    <div class="col-sm-10">
                                        <select name="full_width" id="input-full_width" class="form-control">
                                            <?php if ($full_width) { ?>
                                                <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                                                <option value="0"><?php echo $text_disabled; ?></option>
                                            <?php } else { ?>
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="well">
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-sm-4">
                                                                <label><?php echo $text_slide_kenburns; ?></label>
                                                                <select name="sections[<?php echo $section_row; ?>][slide_kenburns]" class="form-control">
                                                                    <?php foreach ($slide_kenburns as $key => $value) { ?>
                                                                        <option value="<?php echo $key; ?>"
                                                                            <?php echo ($section['slide_kenburns'] == $key) ? 'selected="selected"' : ''; ?>>
          ...
          ">
           ...
           ">
                                                                            ...
                                                                            <div class="preview_single_layer s<?php echo $section_row; ?> g<?php echo $group_row; ?> layer-edit-s<?php echo $section_row; ?>-g<?php echo $group_row; ?> <?php if ($section['groups'][$group_row]['type'] == 'button') {
                                                                                                                                                                                                                                            echo $section['groups'][$group_row]['button_class'];
                                                                                                                                                                                                                                        } ?>" onclick="layerNavigate(<?php echo $section_row; ?>, <?php echo $group_row; ?>);" style="
                                                                    ...
                                                                    <div id="group-row-s<?php echo $section_row; ?>-g<?php echo $group_row; ?>" class="single-layer row<?php echo $group_row; ?>">
                                                                        ...
                                                                        <div class="main">
                                                                            ...
                                                                            <div class="panel panel-default ">
                                                                                ...
                                                                                <div class="panel-heading">
                                                                                    <h3 class="panel-title"><?php echo $text_layer_settings; ?></h3>
                                                                                </div>
                                                                                ...
                                                                                <div class="panel-body">
                                                                                    ...
                                                                                    <?php if ($section['groups'][$group_row]['type'] == 'image') { ?>
                                                                                        <h4><?php echo $text_heading_min_height; ?></h4>
                                                                                        <div class="row border_bottom">
                                                                                            <div class="form-group col-sm-12">
                                                                                                <label><?php echo $text_layer_min_height; ?></label>
                                                                                                <input class="form-control" name="sections[<?php echo $section_row; ?>][groups][<?php echo $group_row; ?>][min_height]" value="<?php echo isset($section['groups'][$group_row]['min_height']) ? $section['groups'][$group_row]['min_height'] : '0'; ?>" />
                                                                                            </div>
                                                                                        </div>
                                                                                    <?php } ?>
                                                                                            ...
                                                                                            <div class="row">
                                                                                                <div class="form-group col-sm-6">
                                                                                                    ...
                                                                                                    <select name="sections[<?php echo $section_row; ?>][groups][<?php echo $group_row; ?>][font]" id="font-s<?php echo $section_row; ?>-g<?php echo $group_row; ?>" class="form-control">
                                                                                                        ...
                                                                                                        <?php foreach ($g_fonts as $g_font) { ?>
                                                                                                            <option value="<?php echo $g_font['name']; ?>" <?php if ($section['groups'][$group_row]['font'] == $g_font['name']) {
                                                                                                                                                                echo 'selected="selected"';
                                                                                                                                                            } ?>><?php echo $g_font['name']; ?></option>
                                                                                                        <?php } ?>
                                                                                                        <?php foreach ($oxyo_fonts as $oxyo_font) { ?>
                                                                                                            <option value="<?php echo $oxyo_font['name']; ?>" <?php if ($section['groups'][$group_row]['font'] == $oxyo_font['name']) {
                                                                                                                                                                    echo 'selected="selected"';
                                                                                                                                                                } ?>><?php echo $oxyo_font['name']; ?></option>
                                                                                                        <?php } ?>
                                                                                                    </select>
                                                                                                </div>
                                                                                                ...
                                                                                                <div class="form-group col-sm-6">
                                                                                                    ...
                                                                                                    <select name="sections[<?php echo $section_row; ?>][groups][<?php echo $group_row; ?>][fontweight]" id="font-weight-s<?php echo $section_row; ?>-g<?php echo $group_row; ?>" class="form-control">
                                                                                                        <?php foreach ($font_weights as $key => $fontweight) { ?>
                                                                                                            <option value="<?php echo $key; ?>"
    ...
    <script type="text/javascript">
        ...
        function addSlide() {
            ...
            html += '<div class="form-group col-sm-4">';
            html += '<label><?php echo $text_slide_kenburns; ?></label>';
        ...
        function addLayer(section_row, layer_type) {
            ...
            if (layer_type == 'text' || layer_type == 'button') {
                ...
                if (layer_type == 'text') {
                    ...
                    <?php } ?>
                    <?php foreach ($oxyo_fonts as $oxyo_font) { ?>
                        html += '<option value="<?php echo addslashes($oxyo_font['name']); ?>">';
                        html += '<?php echo addslashes($oxyo_font['name']); ?>';
                        html += '</option>';
                    <?php } ?>
                    html += '</select>';
                    html += '</div>';
            ...
            if (layer_type == 'image') {
                html += '<h4><?php echo $text_heading_min_height; ?></h4>';
                html += '<div class="row border_bottom">';
                html += '<div class="form-group col-sm-12">';
                html += '<label><?php echo $text_layer_min_height; ?></label>';
                html += '<input class="form-control" type="text" name="sections[' + section_row + '][groups][' + group_row + '][min_height]"  value="0" />';
                html += '</div>';
                html += '</div>';
            }
    ...
    <script type="text/javascript">
        <!--
        $('#input-full_width').change(function() {
            if ($(this).val() == "1") {
