...
<div id="content">
    <div class="page-header">
      ...
      <a class=" btn btn-success" onclick="$('#save').val('stay');$('#form_oxyo_content').submit();" data-toggle="tooltip" title="<?php echo $button_save_stay; ?>"><i class="fa fa-check"></i></a>
            <?php } ?>
            <button type="submit" form="form_oxyo_content" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
    ...
    <div class="container-fluid">
        ...
        <div class="panel-wrapper">
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form_oxyo_content" class="form-horizontal">
    ...
    -->
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane show" id="tab-content">
                        <div class="main-content">
                            ...
                            <div class="left-side">
                                ...
                                <div class="form-group title_field" style="display:<?php if (!empty($b_setting['title'])) {
                                                                                        echo 'block';
                                                                                    } else {
                                                                                        echo 'none';
                                                                                    } ?>">
                                ...
                                <div class="form-group" id="custom_margin_field" style="display:<?php if (!empty($b_setting['custom_m'])) {
                                                                                                    echo 'block';
                                                                                                } else {
                                                                                                    echo 'none';
                                                                                                } ?>">
                                ...
                                <div class="form-group" id="background_color_field" style="display:<?php if (!empty($b_setting['block_bg'])) {
                                                                                                        echo 'block';
                                                                                                    } else {
                                                                                                        echo 'none';
                                                                                                    } ?>">
                                ...
                                <div class="form-group background_image_field" style="display:<?php if (!empty($b_setting['block_bgi'])) {
                                                                                                    echo 'block';
                                                                                                } else {
                                                                                                    echo 'none';
                                                                                                } ?>">
                                ...
                                <div class="form-group background_image_field" id="background_color_field" style="display:<?php if (!empty($b_setting['block_bgi'])) {
                                                                                                                                echo 'block';
                                                                                                                            } else {
                                                                                                                                echo 'none';
                                                                                                                            } ?>">
                                ...
                                <div class="form-group" id="background_video_field" style="display:<?php if (!empty($b_setting['block_bgv'])) {
                                                                                                        echo 'block';
                                                                                                    } else {
                                                                                                        echo 'none';
                                                                                                    } ?>">
                                ...
                                <div class="form-group" id="block_css_field" style="display:<?php if (!empty($b_setting['block_css'])) {
                                                                                                echo 'block';
                                                                                            } else {
                                                                                                echo 'none';
                                                                                            } ?>">
                                ...
                                <div class="form-group" id="content_css_field" style="display:<?php if (!empty($c_setting['block_css'])) {
                                                                                                    echo 'block';
                                                                                                } else {
                                                                                                    echo 'none';
                                                                                                } ?>">
                                ...
                                <div class="tab-content column-holder">
                                    ...
                                    <?php foreach ($columns as $column) { ?>
                                        <div class="tab-pane" id="tab-column-<?php echo $column_row; ?>">
                                            ...
                                            <div class="form-group" id="custom-width-<?php echo $column_row; ?>" style="display:<?php if (($column['w']) == 'custom') {
                                                                                                                                    echo 'block';
                                                                                                                                } else {
                                                                                                                                    echo 'none';
                                                                                                                                } ?>">
                                            ...
                                            <div id="data-holder-<?php echo $column_row; ?>">
                                                ...
                                                <?php if ($column['type'] == 'img') { ?>
                                                    ...
                                                    <a class="btn btn-primary btn-block banner-btn-<?php echo $column_row; ?>" style="margin:20px 20px 10px 20px;display:<?php if (!empty($column['data4'])) {
                                                                                                                                                                                echo "none";
                                                                                                                                                                            } else {
                                                                                                                                                                                echo "block";
                                                                                                                                                                            } ?>" onclick="add_second_banner('<?php echo $column_row; ?>');"><?php echo $text_btn_add_banner; ?></a>
    ...
    <script type="text/javascript">
        ...
        var set_template = function(template, column_row, number) {
            ...
            <?php } ?>
            $('.editor-link-' + column_row + '-' + number + '').text('<?php echo $text_enable_editor; ?>').removeClass('show');
        ...
        var enable_editor = function(column_row, lang_id, number) {
            if ($('#enable_editor-' + column_row + '-' + lang_id + '-' + number + '').hasClass('show')) {
                $('#enable_editor-' + column_row + '-' + lang_id + '-' + number + '').text('<?php echo $text_enable_editor; ?>').removeClass('show');
                $('#textarea-' + column_row + '-' + lang_id + '-' + number + '').summernote('destroy');

            } else {
                $('#enable_editor-' + column_row + '-' + lang_id + '-' + number + '').text('<?php echo $text_disable_editor; ?>').addClass('show');
        ...
        var template_preview = function(template, name) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    html += '      </div>';
                    html += '      <div class="modal-body"><img src="view/javascript/oxyo/content_templates/' + template + '/preview.png"</div>';
                    html += '    </div';
                    html += '  </div>';
                    html += '</div>';
                    $('body').append(html);
        ...
        $(document).delegate('.icon_list', 'click', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    html += '      </div>';
                    html += '      <div class="modal-body" style="padding:30px 0;"><iframe src="view/javascript/oxyo/icons_list/icon_list.html" width="1240" height="560" frameborder="0" allowtransparency="true"></iframe></div>';
                    html += '    </div';
                    html += '  </div>';
                    html += '</div>';
                    $('body').append(html);
        ...
        $(document).delegate('.shortcode_list', 'click', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    html += '      </div>';
                    html += '      <div class="modal-body"><iframe src="view/javascript/oxyo/shortcode_list/shortcode_list.html" width="1240" height="560" frameborder="0" allowtransparency="true"></iframe></div>';
                    html += '    </div';
                    html += '  </div>';
                    html += '</div>';
                    $('body').append(html);
        ...
        $(document).delegate('.overlay_list', 'click', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    html += '      </div>';
                    html += '      <div class="modal-body"><iframe src="view/javascript/oxyo/overlay_list/overlay_list.html" width="1240" height="560" frameborder="0" allowtransparency="true"></iframe></div>';
                    html += '    </div';
                    html += '  </div>';
                    html += '</div>';
                    $('body').append(html);
