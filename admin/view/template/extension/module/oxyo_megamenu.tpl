                                    ...
                                    <div class="right col-md-7 col-xs-12 col-sm-6">
                                        ...
                                        <div class="input clearfix">
                                            ...
                                            <span class="helper">Example: <i>fa fa-desktop</i> or <i>icon-heart</i> &nbsp;-&nbsp;
                                                ...
                                                <a class="icon_list">Oxyo Icons</a>
                                            </span>
                                        </div>
                                                    ...
                                                    <?php } else { ?>
                                                        ...
                                                        <div class="input clearfix">
                                                            ...
                                                            <select name="content_width" class="form-control">
                                                                <?php for ($i = 1; $i < 13; $i++) { ?>
                                                                    <option value="<?php echo $i; ?>" <?php if ($i == $content_width) {
                                                                                                            echo 'selected="selected"';
                                                                                                        } ?>><?php echo $i; ?>/12</option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                                ...
                                                                <div class="tab-content">
                                                                    <?php foreach ($languages as $language) {
                                                                        ...
                                                                        <div id="content_html_<?php echo $language['language_id']; ?>" class="content_html tab-pane">
                                                                            <textarea name="content[html][text][<?php echo $language['language_id']; ?>]" id="content_html_text_<?php echo $language['language_id']; ?>" class="form-control content-block"><?php if (isset($content['html']['text'][$lang_id])) {
                                                                                                                                                                                                                                                                echo $content['html']['text'][$lang_id];
                                                                                                                                                                                                                                                            } ?></textarea>
                                                        ...
                                                        <div id="content_type2" <?php if ($content_type != '2') { ?> style="display:none" <?php } ?> class="content_type">
                                                            ...
                                                            <div class="input clearfix" <?php if ($content['categories']['submenu'] != '2') {
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#head_name_language').change(function() {
                var that = $(this),
                    opt_select = $('option:selected', that).val(),
                    _input = $('#input-headname-' + opt_select);
            ...
            $('#des_language').change(function() {
                var that = $(this),
                    opt_select = $('option:selected', that).val(),
                    _input = $('#input-head-des-' + opt_select);
            ...
            $('#navigation_language').change(function() {
                var that = $(this),
                    opt_select = $('option:selected', that).val(),
                    _input = $('#input-text-navigation-' + opt_select);
            ...
            $('#home_text_language').change(function() {
                var that = $(this),
                    opt_select = $('option:selected', that).val(),
                    _input = $('#input-home-text-' + opt_select);
            ...
            function menu_updatesort(jsonstring) {
                ...
                if (mittXHRobjekt) {
                    ...
                    ajaxRequest.open("GET", "index.php?route=extension/module/oxyo_megamenu&token=<?php echo $_GET['token']; ?>&jsonstring=" + encodeURIComponent(jsonstring), true);
            ...
            $(document).delegate('.icon_list', 'click', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        html += '      </div>';
                        html += '      <div class="modal-body"><iframe src="view/javascript/oxyo/icons_list/icon_list.html" width="1240" height="560" frameborder="0" allowtransparency="true"></iframe></div>';
                        html += '    </div';
                        html += '  </div>';
                        html += '</div>';
                        $('body').append(html);
