...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <select id="header-select" name="settings[oxyo][oxyo_header]" class="form-control">
            <option value="header1" <?php if ($oxyo_header == 'header1') {
                                        echo ' selected="selected"';
                                    } ?>>Header 1</option>
            <option value="header2" <?php if ($oxyo_header == 'header2') {
                                        echo ' selected="selected"';
                                    } ?>>Header 2</option>
            <option value="header3" <?php if ($oxyo_header == 'header3') {
                                        echo ' selected="selected"';
                                    } ?>>Header 3</option>
            <option value="header4" <?php if ($oxyo_header == 'header4') {
                                        echo ' selected="selected"';
                                    } ?>>Header 4</option>
            <option value="header5" <?php if ($oxyo_header == 'header5') {
                                        echo ' selected="selected"';
                                    } ?>>Header 5</option>
            <option value="header6" <?php if ($oxyo_header == 'header6') {
                                        echo ' selected="selected"';
                                    } ?>>Header 6</option>
        </select>
        <div id="header-preview" class="preview-holder">
            <img src="view/javascript/oxyo/img/theme-panel/headers/<?php echo $oxyo_header; ?>.png" />
        </div>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10 toggle-btn">
        <label><input type="radio" name="settings[oxyo][top_line_style]" value="0" <?php if ($top_line_style == '0') {
                                                                                        echo ' checked="checked"';
                                                                                    } ?> /><span>Disabled</span></label>
        <label><input type="radio" name="settings[oxyo][top_line_style]" value="1" <?php if ($top_line_style == '1') {
                                                                                        echo ' checked="checked"';
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <select name="settings[oxyo][top_line_width]" class="form-control">
            <option value="full-width" <?php if ($top_line_width == 'full-width') {
                                            echo ' selected="selected"';
                                        } ?>>Full Width</option>
            <option value="boxed" <?php if ($top_line_width == 'boxed') {
                                        echo ' selected="selected"';
                                    } ?>>Boxed</option>
        </select>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <input class="form-control" name="settings[oxyo][top_line_height]" value="<?php echo isset($top_line_height) ? $top_line_height : '41'; ?>" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <select name="settings[oxyo][main_header_width]" class="form-control">
            <option value="full-width" <?php if ($main_header_width == 'full-width') {
                                            echo ' selected="selected"';
                                        } ?>>Full Width</option>
            <option value="boxed" <?php if ($main_header_width == 'boxed') {
                                        echo ' selected="selected"';
                                    } ?>>Boxed</option>
        </select>
    </div>
    ...
    <div class="col-sm-10">
        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                <input class="form-control" name="settings[oxyo][main_header_height]" value="<?php echo isset($main_header_height) ? $main_header_height : '104'; ?>" />
            </div>

            <div class="col-sm-4">
                <label>Mobile View</label>
                <input class="form-control" name="settings[oxyo][main_header_height_mobile]" value="<?php echo isset($main_header_height_mobile) ? $main_header_height_mobile : '70'; ?>" />
            </div>

            <div class="col-sm-4">
                <label>Sticky Header</label>
                <input class="form-control" name="settings[oxyo][main_header_height_sticky]" value="<?php echo isset($main_header_height_sticky) ? $main_header_height_sticky : '70'; ?>" />
            </div>
...
<div class="form-group">
    ...
    <div class="col-sm-10 toggle-btn">
        <label><input type="radio" name="settings[oxyo][oxyo_sticky_header]" value="0" <?php if ($oxyo_sticky_header == '0') {
                                                                                            echo ' checked="checked"';
                                                                                        } ?> /><span>Disabled</span></label>
        <label><input type="radio" name="settings[oxyo][oxyo_sticky_header]" value="1" <?php if ($oxyo_sticky_header == '1') {
                                                                                            echo ' checked="checked"';
                                                                                        } ?> /><span>Enabled</span></label>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <input class="form-control" name="settings[oxyo][logo_maxwidth]" value="<?php echo isset($logo_maxwidth) ? $logo_maxwidth : '250'; ?>" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <select name="settings[oxyo][main_menu_align]" class="form-control">
            <option value="menu-aligned-left" <?php if ($main_menu_align == 'menu-aligned-left') {
                                                    echo ' selected="selected"';
                                                } ?>>Left</option>
            <option value="menu-aligned-center" <?php if ($main_menu_align == 'menu-aligned-center') {
                                                    echo ' selected="selected"';
                                                } ?>>Center</option>
            <option value="menu-aligned-right" <?php if ($main_menu_align == 'menu-aligned-right') {
                                                    echo ' selected="selected"';
                                                } ?>>Right</option>
        </select>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        ...
        <div class="row">
            <div class="col-sm-4">
                <label>Default</label>
                <input class="form-control" name="settings[oxyo][menu_height_normal]" value="<?php echo isset($menu_height_normal) ? $menu_height_normal : '50'; ?>" />
            </div>

            <div class="col-sm-4">
                <label>Sticky Header</label>
                <input class="form-control" name="settings[oxyo][menu_height_sticky]" value="<?php echo isset($menu_height_sticky) ? $menu_height_sticky : '70'; ?>" />
            </div>
    ...
    <div class="col-sm-10">
        <?php foreach ($languages as $language) { ?>
            <div class="input-group">
                ...
                <input class="form-control" name="settings[oxyo][oxyo_promo][<?php echo $language['language_id']; ?>]" value="<?php echo isset($oxyo_promo[$language['language_id']]) ? $oxyo_promo[$language['language_id']] : ''; ?>" />
            </div>
        <?php } ?>
    </div>
</div>
    ...
    <div class="col-sm-10">
        <?php foreach ($languages as $language) { ?>
            <div class="input-group">
                <span class="input-group-addon">
                    <img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['language_id']; ?>" /></span>
                <input class="form-control" name="settings[oxyo][oxyo_promo2][<?php echo $language['language_id']; ?>]" value="<?php echo isset($oxyo_promo2[$language['language_id']]) ? $oxyo_promo2[$language['language_id']] : ''; ?>" />
            </div>
        <?php } ?>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10 toggle-btn">
        <label><input type="radio" name="settings[oxyo][oxyo_home_overlay_header]" value="0" <?php if ($oxyo_home_overlay_header == '0') {
                                                                                                    echo ' checked="checked"';
                                                                                                } ?> /><span>Disabled</span></label>
        <label><input type="radio" name="settings[oxyo][oxyo_home_overlay_header]" value="1" <?php if ($oxyo_home_overlay_header == '1') {
                                                                                                    echo ' checked="checked"';
                                                                                                } ?> /><span>Enabled</span></label>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10 toggle-btn">
        <label><input type="radio" name="settings[oxyo][header_login]" value="0" <?php if ($header_login == '0') {
                                                                                        echo ' checked="checked"';
                                                                                    } ?> /><span>Disabled</span></label>
        <label><input type="radio" name="settings[oxyo][header_login]" value="1" <?php if ($header_login == '1') {
                                                                                        echo ' checked="checked"';
                                                                                    } ?> /><span>Enabled</span></label>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10 toggle-btn">
        <label><input type="radio" name="settings[oxyo][header_search]" value="0" <?php if ($header_search == '0') {
                                                                                        echo ' checked="checked"';
                                                                                    } ?> /><span>Disabled</span></label>
        <label><input type="radio" name="settings[oxyo][header_search]" value="1" <?php if ($header_search == '1') {
                                                                                        echo ' checked="checked"';
                                                                                    } ?> /><span>Enabled</span></label>
    </div>
</div>
...
<div class="col-sm-offset-2">
    <div class="bs-callout bs-callout-info bs-callout-sm">
        ...
        <p>As <b>Primary Menu</b> and <b>Secondary Menu</b> you can attach either the <i>Default menu from Opencart</i>, or a menu created using the <i>Oxyo Megamenu Module.</i></p>
        <p>Default menu from Opencart = <i>All categories from Catalog > Categories where the "Top" checkbox is checked</i><br />
            Mega Menu Module = <i>Menus created from the module Oxyo Megamenu under Extensions > Extensions -> Modules.</i></p>
        ...
        <select name="settings[oxyo][primary_menu]" class="form-control">
            ...
            <?php foreach ($menu_modules as $menu_module) { ?>
                <?php if ($primary_menu == $menu_module['module_id']) { ?>
                    <option value="<?php echo $menu_module['module_id']; ?>" selected="selected">Oxyo Megamenu: <?php echo $menu_module['name']; ?></option>
                <?php } else { ?>
                    <option value="<?php echo $menu_module['module_id']; ?>">Oxyo Megamenu: <?php echo $menu_module['name']; ?></option>
                <?php } ?>
            <?php } ?>
        </select>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-10 toggle-btn">
        <label><input type="radio" name="settings[oxyo][use_custom_links]" class="links-select" value="0" <?php if ($use_custom_links == '0') {
                                                                                                                echo ' checked="checked"';
                                                                                                            } ?> /><span>Disabled</span></label>
        <label><input type="radio" name="settings[oxyo][use_custom_links]" class="links-select" value="1" <?php if ($use_custom_links == '1') {
                                                                                                                echo ' checked="checked"';
                                                                                                            } ?> /><span>Enabled</span></label>
    </div>
</div>

<div class="row" id="custom_links_holder" <?php if ($use_custom_links) {
                            ...
                            <td class="first">
                                <?php foreach ($languages as $language) { ?>
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="settings[oxyo][oxyo_links][<?php echo $link_row; ?>][text][<?php echo $language['language_id']; ?>]" value="<?php echo isset($oxyo_link['text'][$language['language_id']]) ? $oxyo_link['text'][$language['language_id']] : ''; ?>" size="40" />
                                    </div>
                                <?php } ?>
                            </td>
                            <td class="first">
                                <input type="text" class="form-control" name="settings[oxyo][oxyo_links][<?php echo $link_row; ?>][target]" value="<?php echo isset($oxyo_link['target']) ? $oxyo_link['target'] : ''; ?>" />
                            </td>
                            <td class="first">
                                <input type="text" class="form-control" style="width:60px" name="settings[oxyo][oxyo_links][<?php echo $link_row; ?>][sort]" value="<?php echo isset($oxyo_link['sort']) ? $oxyo_link['sort'] : '0'; ?>" />
                            </td>
                            <td class="text-right">
...
<script type="text/javascript">
    ...
    function addLinkRow() {
        ...
        <?php foreach ($languages as $language) { ?>
            ...
            html += '<input type="text" class="form-control" name="settings[oxyo][oxyo_links][' + link_row + '][text][<?php echo $language['language_id']; ?>]" />';
            html += '</div>';
        <?php } ?>
        html += '</td>';
        html += '<td class="first">';
