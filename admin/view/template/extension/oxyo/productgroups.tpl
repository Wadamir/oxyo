...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
       <div class="pull-right">
        <a class="btn btn-primary" onclick="$('#save').val('stay');$('#form-showintabs').submit();" data-toggle="tooltip" title="<?php echo $button_save; ?>"><i class="fa fa-save"></i></a>
        </div>
  ...
  <div class="panel panel-default">
      ...
      <?php echo $text_info; ?>
      <a href="<?php echo $modules_url; ?>" target="_blank"><?php echo $text_to_modules; ?></a>
      </div>
      </div>
...
var autocomp_cfg = {
  ...
  source: function(request, response) {
    $.ajax({
      url: 'index.php?route=extension/oxyo/productgroups/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
      dataType: 'json',
