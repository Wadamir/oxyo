...
$_['text_success'] = 'Success: You have modified module XD Checkout!';
$_['text_edit'] = 'Edit Module XD Checkout';
...
$_['help_customer_group'] = 'For selection, only the groups that are selected to be displayed during registration in the store settings are available. Works only for guest checkout.';
...
$_['entry_cdek_api_environment'] = 'CDEK API Environment';
$_['text_cdek_api_environment_prod'] = 'Production (api.cdek.ru)';
$_['text_cdek_api_environment_test'] = 'Test (api.edu.cdek.ru)';

// Upload Cities
$_['entry_upload_cities'] = 'Upload Cities';
$_['text_upload_cities_status'] = 'Upload status messages will be displayed here.';
$_['text_upload_cities_progress'] = 'Current Progress';
$_['text_upload_cities_out_of'] = 'out of';
$_['text_upload_cities_demo'] = 'City import starts automatically after opening this window.';
$_['text_upload_cities_ready'] = 'Select countries and click "Start Update".';
$_['text_upload_cities_completed'] = 'Completed. Cities have been uploaded to the database.';
$_['text_upload_cities_reading_file'] = 'Reading data file...';
$_['text_upload_cities_uploading'] = 'Uploading cities to database...';
$_['text_upload_cities_file_unavailable'] = 'Data file is unavailable';
$_['text_upload_cities_session_expired'] = 'Admin session has expired. Refresh the page and sign in again.';
$_['text_upload_cities_error_label'] = 'Error';
$_['text_upload_cities_batch_failed'] = 'Failed to upload cities batch.';
$_['text_upload_cities_init_failed'] = 'Failed to initialize city upload.';
$_['text_upload_cities_demo_mode'] = 'Showing demo upload progress...';
$_['text_upload_cities_local_background_sync'] = 'Cities were loaded from the local file. Background API refresh has started. The database will be updated when it finishes. You can close this window.';
$_['text_upload_cities_local_sync_only'] = 'Cities were loaded from the local file and updated in the database.';
$_['text_upload_cities_local_loaded'] = 'Cities were loaded from the local file.';
$_['text_upload_cities_background_started'] = 'Background API refresh has started. The database will be updated when it finishes. You can close this window.';
$_['text_upload_cities_country_hint'] = 'Select countries to import:';
$_['text_upload_cities_country_ru'] = 'RU';
$_['text_upload_cities_country_by'] = 'BY';
$_['text_upload_cities_country_kz'] = 'KZ';
$_['text_upload_cities_country_required'] = 'Select at least one country.';
$_['text_upload_cities_no_rows_for_selected_countries'] = 'No cities for selected countries were found in the local DB.';
$_['text_upload_cities_no_rows_api_start'] = 'No cities for the selected country were found in the local DB.';
$_['text_upload_cities_no_rows_short'] = 'No cities for the selected country were found in the local DB.';
$_['text_upload_cities_no_rows_recommend_api'] = 'No cities for the selected country were found in the local DB. I recommend updating from API: enable the checkbox and run the update again.';
$_['text_upload_cities_use_api_label'] = 'Update cities from API';
$_['text_upload_cities_use_api_help'] = 'API update will run in the background, and after that the database update will be performed.';
$_['button_upload_cities_start'] = 'Start Update';
$_['button_upload_cities_close'] = 'Close';

// Design
$_['entry_load_screen'] = 'Display Load Screen';
$_['entry_loading_display'] = 'Loading Display';
$_['entry_layout'] = 'Layout';
$_['entry_responsive'] = 'Responsive XD Checkout';
...
$_['entry_field_locality'] = 'Locality';
...
// Error
$_['error_permission'] = 'Warning: You do not have permission to modify module XD Checkout!';
