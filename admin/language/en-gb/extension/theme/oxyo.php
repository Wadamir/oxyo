...
$_['help_product_description_length'] = 'Number of characters in the product description in (categories, manufacturers, etc.). To hide, set 0';
...
$_['error_limits_1'] = 'Specify the limits!';
$_['error_limits_2'] = 'Specify the limits!';
$_['entry_product_limits_1'] = 'Products per page when one side column';
$_['entry_product_limits_2'] = 'Products per page when there are two sidebars or none at all';
