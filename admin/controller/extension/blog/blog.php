...
class ControllerExtensionBlogBlog extends Controller
{
    ...
    private function getForm()
    {
        ...
        $data['entry_vk_video'] = $this->language->get('entry_vk_video');
        ...
        if (isset($this->request->post['vk_video'])) {
            $data['vk_video'] = $this->request->post['vk_video'];
        } elseif (isset($blog_info)) {
            $data['vk_video'] = $blog_info['vk_video'];
        } else {
            $data['vk_video'] = '';
        }
