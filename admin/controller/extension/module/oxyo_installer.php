<?php
class ControllerExtensionModuleOxyoInstaller extends Controller
{
    private $error = array();
    ...
    public function index()
    {
        ...
        $this->load->language('extension/module/oxyo_installer');
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/oxyo_installer', $token_prefix . '=' . $this->session->data[$token_prefix], true)
        );
        ...
        $this->response->setOutput($this->load->view('extension/module/oxyo_installer', $data));
    }
    ...
    {
        // ##################################
        // Add Oxyo Modification
        // ##################################

        if ((float)VERSION >= 3.0) {
            $this->load->model('setting/modification');
            $modification_prefix = 'model_setting_modification';
            $xml = file_get_contents(DIR_APPLICATION . '/view/javascript/oxyo/main_ocmod/oxyo_theme_3X.ocmod.xml');
        } else {
            $this->load->model('extension/modification');
            $modification_prefix = 'model_extension_modification';
            $xml = file_get_contents(DIR_APPLICATION . '/view/javascript/oxyo/main_ocmod/oxyo_theme_23.ocmod.xml');
        }
        ...
        $mod = $this->$modification_prefix->getModificationByCode('oxyo_theme');
        if (!$mod) {
        ...
        $this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/oxyo/oxyo');
        $this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/oxyo/oxyo');
        $this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/oxyo/product_tabs');
        $this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/oxyo/product_tabs');
        $this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/oxyo/productgroups');
        $this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/oxyo/productgroups');
        $this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/oxyo/question');
        $this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/oxyo/question');
        $this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/oxyo/subscriber');
        $this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/oxyo/subscriber');
        $this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/oxyo/testimonial');
        $this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/oxyo/testimonial');
        ...
        $this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/module/oxyo_carousel');
        $this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/module/oxyo_carousel');
        $this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/module/oxyo_categories');
        $this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/module/oxyo_categories');
        $this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/module/oxyo_content');
        $this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/module/oxyo_content');
        $this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/module/oxyo_instagram');
        $this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/module/oxyo_instagram');
        $this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/module/oxyo_layerslider');
        $this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/module/oxyo_layerslider');
        $this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/module/oxyo_megamenu');
        $this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/module/oxyo_megamenu');
        $this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/module/oxyo_products');
        $this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/module/oxyo_products');
