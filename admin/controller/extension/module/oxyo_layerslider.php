...
class ControllerExtensionModuleOxyoLayerslider extends Controller
{
    ...
    public function index()
    {
        ...
        $this->load->language('extension/module/oxyo_layerslider');
        $this->document->setTitle($this->language->get('heading_title'));
        $this->document->addStyle('view/javascript/oxyo/layerslider.css');
        ...
        $this->document->addScript('view/javascript/oxyo/js/removeclasses.js');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            if (!isset($this->request->get['module_id'])) {
                $this->$model_module_path->addModule('oxyo_layerslider', $this->request->post);
            } else {
            ...
            if (isset($this->request->post['save']) && $this->request->post['save'] == 'stay' && $this->request->get['module_id']) {
                $this->response->redirect($this->url->link('extension/module/oxyo_layerslider', $token_prefix . '=' . $this->session->data[$token_prefix] . '&module_id=' . $this->request->get['module_id'], true));
            } else {
        ...
        if (!isset($this->request->get['module_id'])) {
            $data['breadcrumbs'][] = array(
                ...
                'href' => $this->url->link('extension/module/oxyo_layerslider', $token_prefix . '=' . $this->session->data[$token_prefix], true)
            );
        } else {
            $data['breadcrumbs'][] = array(
                'text' => $this->language->get('heading_title'),
                'href' => $this->url->link('extension/module/oxyo_layerslider', $token_prefix . '=' . $this->session->data[$token_prefix] . '&module_id=' . $this->request->get['module_id'], true)
            );
        }

        if (!isset($this->request->get['module_id'])) {
            $data['action'] = $this->url->link('extension/module/oxyo_layerslider', $token_prefix . '=' . $this->session->data[$token_prefix], true);
        } else {
            $data['action'] = $this->url->link('extension/module/oxyo_layerslider', $token_prefix . '=' . $this->session->data[$token_prefix] . '&module_id=' . $this->request->get['module_id'], true);
        }
        ...
        if ($this->config->get('oxyo_design_status')) {
            $data['contrast_color'] = $this->config->get('oxyo_contrast_btn_bg');
        }
        ...
        $this->response->setOutput($this->load->view('extension/module/oxyo_layerslider', $data));
    }

    protected function validate()
    {
        if (!$this->user->hasPermission('modify', 'extension/module/oxyo_layerslider')) {
