...
class ModelExtensionOxyoDemoStoresBase extends Model
{
    ...
    public function addSampleProducts()
    {
        ...
        //Remove existing
        $query = $this->db->query("SELECT product_id FROM " . DB_PREFIX . "product WHERE LOWER(model) LIKE 'oxyo-sample%'");
        ...
        $products[] = array(
            ...
            'image' => 'catalog/oxyo-demo/product.png',
            'sku' => '',
            'upc' => '',
            'ean' => '',
            'jan' => '',
    ...
    {
        $existing = $this->db->query("SELECT product_id FROM " . DB_PREFIX . "product WHERE model = 'oxyo-sample-1'");
        if (!empty($existing->row['product_id'])) {
            return $existing->row['product_id'];
        } else {
            return 0;
        }
    }
    ...
    public function addSampleCategories()
    {
        ...
        $category[] = array(
            ...
            'image' => 'catalog/oxyo-demo/category.png',
    ...
    public function getCategoryId1()
    {
        ...
        if (!empty($existing->row['category_id'])) {
            return $existing->row['category_id'];
        } else {
            return 0;
        }
    }
    ...
    public function addSampleBlogs()
    {
        ...
        $blogs[] = array(
            ...
            'image' => 'catalog/oxyo-demo/blog.png',
            'status' => '1',
            'sort_order' => '',
            'keyword' => '',
            'allow_comment' => '1',
    ...
    public function addSampleTestimonials()
    {
		...
		('1', 'John Doe', 'catalog/oxyo-demo/testimonial-author.png', 'New York', '1'),
		('2', 'Johanna Doe', 'catalog/oxyo-demo/testimonial-author.png', 'London', '1'),
		('3', 'Karl', 'catalog/oxyo-demo/testimonial-author.png', 'Stockholm', '1');
		";
		...
		('1', '1', 'Oxyo is really a great theme! Diam a vestibulum diam nisi augue dictumst parturient a vestibulum tortor viverra inceptos adipiscing nec a ullamcorper.Ullamcorper aliquam rutrum.'),
		('2', '1', 'Oxyo is really a great theme! Diam a vestibulum diam nisi augue dictumst parturient a vestibulum tortor viverra inceptos adipiscing nec a ullamcorper.Ullamcorper aliquam rutrum.'),
		('3', '1', 'Oxyo is really a great theme! Diam a vestibulum diam nisi augue dictumst parturient a vestibulum tortor viverra inceptos adipiscing nec a ullamcorper.Ullamcorper aliquam rutrum.'),
		('1', '2', 'Oxyo is really a great theme! Diam a vestibulum diam nisi augue dictumst parturient a vestibulum tortor viverra inceptos adipiscing nec a ullamcorper.Ullamcorper aliquam rutrum.'),
		('2', '2', 'Oxyo is really a great theme! Diam a vestibulum diam nisi augue dictumst parturient a vestibulum tortor viverra inceptos adipiscing nec a ullamcorper.Ullamcorper aliquam rutrum.'),
		('3', '2', 'Oxyo is really a great theme! Diam a vestibulum diam nisi augue dictumst parturient a vestibulum tortor viverra inceptos adipiscing nec a ullamcorper.Ullamcorper aliquam rutrum.'),
		('1', '3', 'Oxyo is really a great theme! Diam a vestibulum diam nisi augue dictumst parturient a vestibulum tortor viverra inceptos adipiscing nec a ullamcorper.Ullamcorper aliquam rutrum.'),
		('2', '3', 'Oxyo is really a great theme! Diam a vestibulum diam nisi augue dictumst parturient a vestibulum tortor viverra inceptos adipiscing nec a ullamcorper.Ullamcorper aliquam rutrum.'),
		('3', '3', 'Oxyo is really a great theme! Diam a vestibulum diam nisi augue dictumst parturient a vestibulum tortor viverra inceptos adipiscing nec a ullamcorper.Ullamcorper aliquam rutrum.'),
		('1', '4', 'Oxyo is really a great theme! Diam a vestibulum diam nisi augue dictumst parturient a vestibulum tortor viverra inceptos adipiscing nec a ullamcorper.Ullamcorper aliquam rutrum.'),
		('2', '4', 'Oxyo is really a great theme! Diam a vestibulum diam nisi augue dictumst parturient a vestibulum tortor viverra inceptos adipiscing nec a ullamcorper.Ullamcorper aliquam rutrum.'),
		('3', '4', 'Oxyo is really a great theme! Diam a vestibulum diam nisi augue dictumst parturient a vestibulum tortor viverra inceptos adipiscing nec a ullamcorper.Ullamcorper aliquam rutrum.');
		";
    ...
    public function addSampleMenuItems()
    {
        ...
        $oc_mega_menu = array(
            ...
            array('id' => '2', 'parent_id' => '0', 'rang' => '1', 'icon' => 'catalog/oxyo-demo/menu-shop-bg.jpg', 'name' => 'a:3:{i:1;s:4:"Shop";i:3;s:4:"Shop";i:2;s:4:"Shop";}', 'module_id' => '32', 'link' => '', 'description' => 'a:3:{i:1;s:55:"&lt;i class=&quot;menu-tag sale&quot;&gt;SALE&lt;/i&gt;";i:3;s:55:"&lt;i class=&quot;menu-tag sale&quot;&gt;SALE&lt;/i&gt;";i:2;s:55:"&lt;i class=&quot;menu-tag sale&quot;&gt;SALE&lt;/i&gt;";}', 'new_window' => '0', 'status' => '0', 'disp_mobile_item' => '1', 'item_type' => '1', 'show_title' => '0', 'position' => 'right top', 'submenu_width' => '800', 'submenu_type' => '0', 'content_width' => '4', 'content_type' => '0', 'content' => '{"html":{"text":{"1":"","3":"","2":""}},"product":{"id":"","name":"","img_w":"262","img_h":"334"},"image":{"link":"no_image.png"},"categories":{"categories":[],"columns":"1","submenu":"1","submenu_columns":"1"}}', 'icon_font' => '', 'class_menu' => ''),
            ...
            array('id' => '28', 'parent_id' => '0', 'rang' => '0', 'icon' => 'catalog/oxyo-demo/menu-female.jpg', 'name' => 'a:4:{i:1;s:18:"Women’s Clothing";i:4;s:18:"Women’s Clothing";i:3;s:18:"Women’s Clothing";i:2;s:18:"Women’s Clothing";}', 'module_id' => '35', 'link' => '', 'description' => 'a:4:{i:1;s:0:"";i:4;s:0:"";i:3;s:0:"";i:2;s:0:"";}', 'new_window' => '0', 'status' => '0', 'disp_mobile_item' => '1', 'item_type' => '1', 'show_title' => '0', 'position' => 'right bottom', 'submenu_width' => '825', 'submenu_type' => '0', 'content_width' => '4', 'content_type' => '0', 'content' => '{"html":{"text":{"1":"","4":"","3":"","2":""}},"product":{"id":"","name":"","img_w":"262","img_h":"334"},"image":{"link":"no_image.png"},"categories":{"categories":[],"columns":"1","submenu":"1","submenu_columns":"1"}}', 'icon_font' => '', 'class_menu' => ''),
            ...
            array('id' => '75', 'parent_id' => '0', 'rang' => '1', 'icon' => 'catalog/oxyo-demo/menu-shop-bg.jpg', 'name' => 'a:3:{i:1;s:4:"Shop";i:3;s:4:"Shop";i:2;s:4:"Shop";}', 'module_id' => '52', 'link' => '', 'description' => 'a:3:{i:1;s:55:"&lt;i class=&quot;menu-tag sale&quot;&gt;SALE&lt;/i&gt;";i:3;s:55:"&lt;i class=&quot;menu-tag sale&quot;&gt;SALE&lt;/i&gt;";i:2;s:55:"&lt;i class=&quot;menu-tag sale&quot;&gt;SALE&lt;/i&gt;";}', 'new_window' => '0', 'status' => '0', 'disp_mobile_item' => '1', 'item_type' => '1', 'show_title' => '0', 'position' => 'right top', 'submenu_width' => '800', 'submenu_type' => '0', 'content_width' => '4', 'content_type' => '0', 'content' => '{"html":{"text":{"1":"","3":"","2":""}},"product":{"id":"","name":"","img_w":"262","img_h":"334"},"image":{"link":"no_image.png"},"categories":{"categories":[],"columns":"1","submenu":"1","submenu_columns":"1"}}', 'icon_font' => '', 'class_menu' => ''),
            ...
            array('id' => '84', 'parent_id' => '0', 'rang' => '1', 'icon' => 'catalog/oxyo-demo/menu-shop-bg.jpg', 'name' => 'a:3:{i:1;s:4:"Shop";i:3;s:4:"Shop";i:2;s:4:"Shop";}', 'module_id' => '55', 'link' => '', 'description' => 'a:3:{i:1;s:55:"&lt;i class=&quot;menu-tag sale&quot;&gt;SALE&lt;/i&gt;";i:3;s:55:"&lt;i class=&quot;menu-tag sale&quot;&gt;SALE&lt;/i&gt;";i:2;s:55:"&lt;i class=&quot;menu-tag sale&quot;&gt;SALE&lt;/i&gt;";}', 'new_window' => '0', 'status' => '0', 'disp_mobile_item' => '1', 'item_type' => '1', 'show_title' => '0', 'position' => 'right top', 'submenu_width' => '800', 'submenu_type' => '0', 'content_width' => '4', 'content_type' => '0', 'content' => '{"html":{"text":{"1":"","3":"","2":""}},"product":{"id":"","name":"","img_w":"262","img_h":"334"},"image":{"link":"no_image.png"},"categories":{"categories":[],"columns":"1","submenu":"1","submenu_columns":"1"}}', 'icon_font' => '', 'class_menu' => ''),
	...
	{
		"1":[
		{"title":"Brand 1","link":"","image":"catalog\/oxyo-demo\/sample-brand.png","sort_order":"1"},
		{"title":"Brand 2","link":"","image":"catalog\/oxyo-demo\/sample-brand.png","sort_order":"2"},
		{"title":"Brand 3","link":"","image":"catalog\/oxyo-demo\/sample-brand.png","sort_order":"3"},
		{"title":"Brand 4","link":"","image":"catalog\/oxyo-demo\/sample-brand.png","sort_order":"4"},
		{"title":"Brand 5","link":"","image":"catalog\/oxyo-demo\/sample-brand.png","sort_order":"5"},
		{"title":"Brand 6","link":"","image":"catalog\/oxyo-demo\/sample-brand.png","sort_order":"6"},
		{"title":"Brand 7","link":"","image":"catalog\/oxyo-demo\/sample-brand.png","sort_order":"7"}
		],
		"2":{
		"7":{"title":"Brand 1","link":"","image":"catalog\/oxyo-demo\/sample-brand.png","sort_order":"1"},
		"8":{"title":"Brand 2","link":"","image":"catalog\/oxyo-demo\/sample-brand.png","sort_order":"2"},
		"9":{"title":"Brand 3","link":"","image":"catalog\/oxyo-demo\/sample-brand.png","sort_order":"3"},
		"10":{"title":"Brand 4","link":"","image":"catalog\/oxyo-demo\/sample-brand.png","sort_order":"4"},
		"11":{"title":"Brand 5","link":"","image":"catalog\/oxyo-demo\/sample-brand.png","sort_order":"5"},
		"12":{"title":"Brand 6","link":"","image":"catalog\/oxyo-demo\/sample-brand.png","sort_order":"6"},
		"13":{"title":"Brand 7","link":"","image":"catalog\/oxyo-demo\/sample-brand.png","sort_order":"7"}
		},
		"3":{
		"14":{"title":"Brand 1","link":"","image":"catalog\/oxyo-demo\/sample-brand.png","sort_order":"1"},
		"15":{"title":"Brand 2","link":"","image":"catalog\/oxyo-demo\/sample-brand.png","sort_order":"2"},
		"16":{"title":"Brand 3","link":"","image":"catalog\/oxyo-demo\/sample-brand.png","sort_order":"3"},
		"17":{"title":"Brand 4","link":"","image":"catalog\/oxyo-demo\/sample-brand.png","sort_order":"4"},
		"18":{"title":"Brand 5","link":"","image":"catalog\/oxyo-demo\/sample-brand.png","sort_order":"5"},
		"19":{"title":"Brand 6","link":"","image":"catalog\/oxyo-demo\/sample-brand.png","sort_order":"6"},
		"20":{"title":"Brand 7","link":"","image":"catalog\/oxyo-demo\/sample-brand.png","sort_order":"7"}
		}}} 
	', true);
    ...
    public function getBannerId()
    {
        ...
        if (!empty($banner_id->row['banner_id'])) {
            return $banner_id->row['banner_id'];
        } else {
            return 0;
        }
    }
