<div class="widget blog-widget<?php if ($columns != 'list') echo ' grid';
                                if ($contrast) echo ' contrast-bg'; ?>" <?php if ($use_margin) echo 'style="margin-bottom:' . $margin . '"'; ?>>
    <?php if ($block_title) { ?>
            ...
            <?php foreach ($posts as $blog) { ?>
                <div class="item single-blog">
                    <?php if ($blog['image'] && $thumb) { ?>
                        <div class="banner_wrap hover-zoom hover-darken__" <?php if ($columns == 'list') echo ' style="width:' . $img_width . 'px"'; ?>>
                    ...
                    <?php if ($columns == '4') { ?>
                        ...
                        responsive: [{
                            ...
                            <?php } elseif ($columns == '3') { ?>
                                slidesToShow: 3, slidesToScroll: 3, responsive: [{
                                        breakpoint: 600,
                                        settings: {
                                            slidesToShow: 2,
                                            slidesToScroll: 2
