...
<?php if (($product['quantity'] < 1) && ($stock_badge_status)) { ?>
	...
	<?php $button_cart = $oxyo_text_out_of_stock; ?>
<?php } else { ?>
...
<a class="icon is_quickview hidden-xs" onclick="quickview('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" data-placement="<?php echo $tooltip_align; ?>" data-title="<?php echo $oxyo_button_quickview; ?>"><span class="icon-magnifier-add"></span></a>
</div> <!-- .icons-wrapper -->
</div><!-- .image ends -->
<div class="caption">
...
<a class="btn catalog_hide <?php if ($oxyo_list_style == '6') { echo 'btn-contrast'; } else { echo 'btn-outline';} ?>" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><span class="global-cart"></span><?php echo $button_cart; ?></a>
</div><!-- .price-wrapper -->
...
<a class="icon is_quickview link-hover-color" onclick="quickview('<?php echo $product['product_id']; ?>');"><span class="icon-magnifier-add"></span> <?php echo $oxyo_button_quickview; ?></a>
</div><!-- .plain-links-->
</div><!-- .caption-->
