(function (global, factory) {
    ...
    var ZoomImages = (function () {
        function ZoomImages(el, slide) {
            ...
            // Expose instance on DOM element for external usage
            this.img.__zoomInstance = this;
        ...
        return _createClass(ZoomImages, [
            {
                ...
                value: function zoomIn() {
                    ...
                    if (img.naturalWidth > winWidth) {
                        ...
                        if (img.naturalWidth > winWidth * 1.3) {
                            centerX = 0;
                        }
        ...
        var touchInstance = new TouchEvents(sliderWrapper, {
            touchStart: function touchStart(e) {
                ...
                if (process) {
                    ...
                    // Tap detection: store start time and coords
                    tapStartTime = Date.now();
                    tapStartX = startCoords.pageX;
                    tapStartY = startCoords.pageY;
            ...
            touchMove: function touchMove(e) {
                ...
                if (!mediaImage) {
                    return cssTransform(
                        media,
                        'translate3d(' + hDistancePercent + '%, 0, 0)',
                    );
                }
            ...
            // >>> HERE we distinguish tap from swipe/end <<<
            ...
            //     // Update endCoords from changedTouches
            ...
            //             e.preventDefault();
            //             console.log('[tap] toggling .zoomed on currentSlide');

            //             if (currentSlide.classList.contains('zoomed')) {
            //                 currentSlide.classList.remove('zoomed');
            //                 // Do not touch pinch-zoom internals, only CSS-based zoom
            //             } else {
            //                 currentSlide.classList.add('zoomed');
            //             }

            //             // Do not run swipe/close logic for tap
            //             doingMove = false;
            //             return;
            //         }
            //     }

            //     // Original behavior after we ruled out "tap"
            //     doingMove = false;
