<?php
class ControllerExtensionOxyoLiveSearch extends Controller
{
    public function index()
    {
        ...
        if (!$error) {
            ...
            $json['oxyo_text_view_all'] = $this->language->get('oxyo_text_view_all');
            $json['search_url'] = $this->url->link('product/search');
            $json['oxyo_text_no_result'] = $this->language->get('oxyo_text_no_result');
