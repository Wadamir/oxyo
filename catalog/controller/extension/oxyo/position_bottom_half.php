<?php
class ControllerExtensionOxyoPositionBottomHalf extends Controller
{
    public function index()
    {
        ...
        $modules = $this->model_design_layout->getLayoutModules($layout_id, 'bottom_half');
        ...
        return $this->load->view('common/position_bottom_half', $data);
    }
}
