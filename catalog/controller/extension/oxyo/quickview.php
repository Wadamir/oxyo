<?php
class ControllerExtensionOxyoQuickview extends Controller
{
    public function index()
    {
        ...
        if ($product_info) {
            ...
            $data['oxyo_text_view_details'] = $this->language->get('oxyo_text_view_details');
            $data['oxyo_text_select_option'] = $this->language->get('oxyo_text_select_option');
