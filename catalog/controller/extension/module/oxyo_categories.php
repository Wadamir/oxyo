...
class ControllerExtensionModuleOxyoCategories extends Controller
{
    public function index($setting)
    {
        ...
        $data['oxyo_text_view_products'] = $this->language->get('oxyo_text_view_products');
        ...
        if (!empty($setting['category'])) {
            ...
            foreach ($setting['category'] as $category) {
                ...
                $data['categories'][] = array(
                    ...
                    'products'    => $this->model_catalog_product->getTotalProducts($filter_data_top) . $this->language->get('oxyo_text_products'),
        ...
        if ($this->config->get('theme_default_directory') == 'oxyo')
            return $this->load->view('extension/module/oxyo_categories', $data);
    }
}
