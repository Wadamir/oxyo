...
class ControllerProductProduct extends Controller {
    ...
    public function index() {
        ...
        if ($product_info) {
            ...
            $data['sku'] = $product_info['sku'] ? $product_info['sku'] : '';
            $data['upc'] = $product_info['upc'] ? $product_info['upc'] : '';
            $data['weight'] = $product_info['weight'] ? $this->weight->format($product_info['weight'], $product_info['weight_class_id']) : '';
            ...
            if ($product_info['video']) {
                if ($this->request->server['HTTPS']) {
                    $data['video'] = $this->config->get('config_ssl') . 'image/' . $product_info['video'];
                } else {
                    $data['video'] = $this->config->get('config_url') . 'image/' . $product_info['video'];
                }
            } else {
                $data['video'] = '';
            }
            ...
            // Additional image height and width
